...
export default {
	data() {
		return {
			...
			// 轮播图片
			swiperList: [
				{ id: 1, src: 'url1', img: '/static/img/sexy1.png' },
				{ id: 2, src: 'url2', img: '/static/img/sexy2.png' },
				{ id: 3, src: 'url3', img: '/static/img/sexy3.png' },
				{ id: 4, src: 'url3', img: '/static/img/sexy4.png' }
			],
			// 分类菜单
			categoryList: [
				{ id: 1, name: '赏图', img: '/static/img/category/1.png' },
				{ id: 2, name: '看书', img: '/static/img/category/2.png' },
				{ id: 3, name: '音乐', img: '/static/img/category/3.png' ,url: './music/music'},
				{ id: 4, name: '游戏', img: '/static/img/category/4.png' },
				{ id: 5, name: '看剧', img: '/static/img/category/5.png' },
				{ id: 6, name: '软件', img: '/static/img/category/6.png' },
				{ id: 7, name: '视频', img: '/static/img/category/7.png' ,url: './video/video'},
				{ id: 8, name: '英语', img: '/static/img/category/8.png' },
				{ id: 9, name: '漫画', img: '/static/img/category/5.png' },
				{ id: 10, name: '新闻', img: '/static/img/category/6.png' },
				{ id: 11, name: '赏花', img: '/static/img/category/7.png' },
				{ id: 12, name: '热点', img: '/static/img/category/8.png' }
