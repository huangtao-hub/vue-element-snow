...
import org.linlinjava.litemall.db.dao.LitemallTaskMapper;
...
@Service
public class LitemallTaskService {
    @Resource
    private LitemallCartMapper cartMapper;
    @Resource
    private LitemallTaskMapper taskMapper;
    ...
    public void add(LitemallTask task) {
        task.setAddTime(LocalDateTime.now());
        task.setUpdateTime(LocalDateTime.now());
        taskMapper.insertSelective(task);
    }

    public int updateById(LitemallTask task) {
        task.setUpdateTime(LocalDateTime.now());
        return taskMapper.updateByPrimaryKeySelective(task);
    }

    public List<LitemallTask> queryByUid(int userId) {
    ...
    public LitemallTask findById(Integer id) {
        return taskMapper.selectByPrimaryKey(id);
    }

    public LitemallTask findById(Integer userId, Integer id) {
        LitemallTaskExample example = new LitemallTaskExample();
    ...
    public void deleteById(Integer id) {
        taskMapper.logicalDeleteByPrimaryKey(id);
    }
